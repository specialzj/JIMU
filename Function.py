        ...
        for pose_cfg in config_list:
            if "tpose" in pose_cfg or "jpose" in pose_cfg:
                ...
                if task_type == "MoveL":
                    ...
                    pose_name = config_list[pose_cfg][0][0]
                    if robot_cfg[4] == "same" and not pose_name.startswith(("l_", "r_")):#选择左右base
                ...
                if self.robot == "W1":
                ...
                elif self.robot == "AGILE" and robot_cfg[1] != 0 and robot_cfg[3] != 0:
                    ...
                    # self.agile_instruction.gripper(robot_name, gripper_status)
